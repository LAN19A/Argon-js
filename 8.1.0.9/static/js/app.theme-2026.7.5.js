(function(t) {
    function e(e) {
        for (var s, o, r = e[0], l = e[1], c = e[2], p = 0, u = []; p < r.length; p++) o = r[p], Object.prototype.hasOwnProperty.call(i, o) && i[o] && u.push(i[o][0]), i[o] = 0;
    ...
    "56d7": function(t, e, a) {
        ...
        g.a.defaults.withCredentials = !0, g.a.interceptors.response.use(t => t, t => {
            if (t.response) switch (t.response.status) {
                case 401:
                    window.sessionStorage.clear(), window.location.clear(), za.push({
                        name: "login"
                    });
                    break;
                case 400:
                    3 === t.response.data.code && za.push({
                        name: "error_401"
                    });
                    break;
                case 403:
        ...
        var A = {
            get(t, e) {
                ...
                }, g.a.defaults.headers["Content-Type"] = "application/json;charset=utf-8", new Promise((a, s) => {
                    g.a.get(t, {
                        params: e
                    }).then((function(t) {
                        a(t)
                ...
                return g.a.defaults.headers.common = {
                    Authorization: O.getters.getToken
                }, g.a.defaults.headers["Content-Type"] = "application/x-www-form-urlencoded", new Promise((a, s) => {
        ...
        const P = t => A.get("/agent/api/guest/comm/config", t).then(t => t.data),
            B = t => A.post("/agent/api/passport/auth/login", t).then(t => t.data),
            N = t => A.post("/agent/api/passport/comm/sendEmailVerify", t).then(t => t.data),
            I = t => A.post("/agent/api/passport/auth/register", t).then(t => t.data),
            z = t => A.post("/agent/api/passport/auth/forget", t).then(t => t.data);
        var M = {
                data() {
                    return {
                    ...
                    toggleSidebar() {
                        ...
                        sessionStorage.clear(), localStorage.clear(), this.$store.commit("setToken", null), setTimeout(() => {
                            this.$router.push({
                                path: "/login"
                            })
                        }, 1e3)
            ...
            R = M,
            L = Object(o["a"])(R, m, h, !1, null, null, null),
            W = L.exports,
            E = function() {
                var t = this,
                    e = t._self._c;
                ...
                }, [e("span", [t._v(" " + t._s(t.user.email))])]), e("div", {
            ...
            V = {
                ...
                mounted() {
                    let t = this;
                    F.$on("sidebar", (function() {
                        t.showSidebar && (t.showSidebar = !1)
                    })), F.$on("LoginSidebar", (function() {
                        t.showSidebar = !0
                    }))
                },
                provide() {
            ...
            Y = V,
            H = Object(o["a"])(Y, E, q, !1, null, null, null),
            U = H.exports,
            Q = function() {
                var t = this,
                    e = t._self._c;
            ...
            Z = {
                ...
                methods: {
                    linkClick() {
                        this.autoClose && F.$emit("sidebar")
                    }
                }
            },
            K = Z,
            G = Object(o["a"])(K, Q, J, !1, null, null, null),
            X = G.exports,
            tt = function() {
                var t = this,
                    e = t._self._c;
            ...
            st = at,
            it = Object(o["a"])(st, tt, et, !1, null, null, null),
            nt = it.exports;
        const ot = t => A.get("/agent/api/user/info", t).then(t => t.data),
            rt = t => A.get("/agent/api/user/notice/fetch", t).then(t => t.data),
            lt = t => A.get("/agent/api/user/getSubscribe", t).then(t => t.data),
            ct = t => A.get("/agent/api/user/getStat", t).then(t => t.data),
            dt = t => A.get("/agent/api/user/knowledge/fetch", t).then(t => t.data),
            pt = t => A.get("/agent/api/user/server/fetch", t).then(t => t.data),
            ut = t => A.get("/agent/api/user/plan/fetch", t).then(t => t.data),
            mt = t => A.get("/agent/api/user/order/detail", t).then(t => t.data),
            ht = t => A.get("/agent/api/user/order/getPaymentMethod", t).then(t => t.data),
            ft = t => A.get("/agent/api/user/order/check", t).then(t => t.data),
            gt = t => A.post("/agent/api/user/coupon/check", t).then(t => t.data),
            vt = t => A.post("/agent/api/user/order/save", t).then(t => t.data),
            bt = t => A.post("/agent/api/user/order/checkout", t).then(t => t.data),
            _t = t => A.get("/agent/api/user/order/fetch", t).then(t => t.data),
            yt = t => A.get("/agent/api/user/invite/fetch", t).then(t => t.data),
            Ct = t => A.get("/agent/api/user/invite/save", t).then(t => t.data),
            wt = t => A.get("/agent/api/user/invite/details", t).then(t => t.data),
            xt = t => A.get("/agent/api/user/resetSecurity", t).then(t => t.data),
            kt = t => A.get("/agent/api/user/comm/config", t).then(t => t.data),
            St = t => A.post("/agent/api/user/transfer", t).then(t => t.data),
            jt = t => A.post("/agent/api/user/ticket/withdraw", t).then(t => t.data),
            $t = t => A.post("/agent/api/user/changePassword", t).then(t => t.data),
            Dt = t => A.post("/agent/api/user/update", t).then(t => t.data),
            Tt = t => A.get("/agent/api/user/telegram/getBotInfo", t).then(t => t.data),
            Ot = t => A.get("/agent/api/user/ticket/fetch", t).then(t => t.data),
            At = t => A.post("/agent/api/user/ticket/save", t).then(t => t.data),
            Pt = t => A.post("/agent/api/user/ticket/close", t).then(t => t.data),
            Bt = t => A.post("/agent/api/user/ticket/reply", t).then(t => t.data),
            Nt = t => A.get("/agent/api/user/ticket/fetch", t).then(t => t.data),
            It = t => A.get("/agent/api/user/stat/getTrafficLog", t).then(t => t.data),
            zt = t => A.post("/agent/api/user/order/cancel", t).then(t => t.data);
        var Mt = {
                components: {
                    DashboardNavbar: W,
                    ContentFooter: nt,
            ...
            Rt = Mt,
            Lt = (a("d0b6"), Object(o["a"])(Rt, p, u, !1, null, null, null)),
            Wt = Lt.exports,
            Et = function() {
                var t = this,
                    e = t._self._c;
                ...
                }, [t._v(" " + t._s(t.app_description) + " ")])])])])]), e("div", {
            ...
            Vt = Ft,
            Yt = Object(o["a"])(Vt, Et, qt, !1, null, null, null),
            Ht = Yt.exports,
            Ut = function() {
                var t = this,
                    e = t._self._c;
                return e("div", [e("a-spin", {
                    ...
                    scopedSlots: t._u([{
                        key: "footer",
                        fn: function() {
                            return [t.sub.reset_day ? e("span", {
                                staticClass: "text-nowrap"
                            }, [t._v("距离重置流量还有 " + t._s(t.sub.reset_day) + " 天")]) : e("span", {
                                staticClass: "text-nowrap"
                            }, [t._v("暂无数据")])]
                        },
                        proxy: !0
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function() {
                            return [e("span", {
                                staticClass: "text-nowrap"
                            }, [t._v("总计 " + t._s(t._f("bytesToSize")(t.sub.transfer_enable)))])]
                        },
                        proxy: !0
                    }])
                })], 1), e("div", {
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function() {
                            return [e("span", {
                                staticClass: "text-nowrap"
                            }, [t._v("可用佣金 " + t._s(t._f("money")(t.user.commission_balance)))])]
                        },
                        proxy: !0
                    }])
                })], 1), e("div", {
                    ...
                    staticClass: "mb-0"
                }, [t._v("我的套餐")])]), t.sub.plan ? e("div", {
                    staticClass: "card-body"
                }, [e("div", {
                    staticClass: "row"
                }, [e("div", {
                    staticClass: "col-lg-8"
                }, [e("strong", [t._v(" " + t._s(t.sub.plan.name) + " ")]), t.sub.expired_at ? e("p", [t._v(" 于 " + t._s(t._f("formatDate")(t.sub.expired_at)) + " 到期，距离到期还有 " + t._s(t._f("intervalDay")(t.sub.expired_at)) + " 天，" + t._s(t.sub.reset_day) + " 日后重置流量 ")]) : e("p", [t._v("该订阅长期有效")]), e("base-progress", {
                    attrs: {
                        "show-label": "",
                        type: "primary",
                        height: 8,
                ...
                }), e("p", [t._v(" 已用 " + t._s(t._f("bytesToSize")(t.sub.u + t.sub.d)) + " / 总计 " + t._s(t._f("bytesToSize")(t.sub.transfer_enable)) + " ")])], 1), e("div", {
                    ...
                    attrs: {
                        image: "https://www.leigod.com/article/img/battlenet/blizzard/blizzard_partThree_img4.png",
                        "image-style": {
                            height: "60px"
                        }
                    }
                ...
                }, [t.show_client.Hiddify ? e("base-dropdown", {
                    ...
                    directives: [{
                        ...
                        value: t.sub.subscribe_url + "?flag=hiddify/LAN",
                        expression: "sub.subscribe_url + '?flag=hiddify/LAN'",
                        arg: "copy"
                    }, {
                        name: "clipboard",
                    ...
                    staticClass: "dropdown-item"
                }, [t._v("复制 Hiddify 订阅")]), e("a", {
                    staticClass: "dropdown-item",
                    on: {
                        click: function(e) {
                            return t.importSublink("hiddify")
                        }
                    }
                }, [t._v("一键导入 Hiddify")])]) : t._e(), t.show_client.Clash ? e("base-dropdown", {
                    staticClass: "sub-button",
                    scopedSlots: t._u([{
                        key: "title",
                        fn: function() {
                ...
                }, [t._v("一键导入 Clash")])]) : t._e(), t.show_client.Shadowrocket ? e("base-dropdown", {
                    staticClass: "sub-button",
                    scopedSlots: t._u([{
                        key: "title",
                        fn: function() {
                ...
                }, [t._v("一键导入 Shadowrocket")])]) : t._e(), t.show_client.Surge ? e("base-button", {
                    directives: [{
                        name: "clipboard",
                        rawName: "v-clipboard:copy",
                ...
                }, [t._v("Surge 订阅")]) : t._e(), t.show_client.V2Ray ? e("base-button", {
                    directives: [{
                        name: "clipboard",
                        rawName: "v-clipboard:copy",
                        value: t.sub.subscribe_url + "?flag=v2rayn",
                        expression: "sub.subscribe_url + '?flag=v2rayn'",
                        arg: "copy"
                    }, {
                        name: "clipboard",
                        rawName: "v-clipboard:success",
                ...
                }, [t._v(" 复制 V2Ray 订阅")]) : t._e(), t.show_client.Surfboard ? e("base-dropdown", {
                    staticClass: "sub-button",
                    scopedSlots: t._u([{
                        key: "title",
                        fn: function() {
                ...
                }, [t._v("一键导入 Surfboard")])]) : t._e()], 1) : e("div", {
                    staticClass: "card-body text-center"
                }, [e("a-empty", {
                    attrs: {
                        image: "https://www.leigod.com/article/img/battlenet/blizzard/blizzard_partThree_img4.png",
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function() {
                            ...
                            }, t._l(t.noticeList, (function(t, a) {
                                return e("div", {
                                    key: a
                                }, [e("img", {
                ...
                }, [t._v(t._s(t.noticeDetail.title))]), e("p", {
                ...
                }, [t._v(t._s(t._f("formatDate")(t.noticeDetail.updated_at)))])])])])], 1)])])], 1), e("modal", {
                    attrs: {
                        show: t.modal2,
                ...
                }, [t._v("确定要重置节点信息？")]), e("p", [t._v("如果你的节点订阅地址或信息泄露可以进行此操作。重置后你的UUID及订阅将会变更，需要重新进行订阅节点。")])])]), e("modal", {
                    attrs: {
                        show: t.modal3,
                        "modal-classes": "modal-dialog-centered",
                        showClose: !0
                    ...
                    staticClass: "heading mt-4"
                }, [t._v("确定要重置当月流量？")]), e("p", [t._v("点击「确定」将会跳转到收银台，支付订单后系统将会清空您当月已使用流量。")])])])], 1)
            },
            Qt = [],
            Jt = (a("b7ef"), {
                components: {},
                ...
                methods: {
                    setNotice(t) {
                        ...
                        let e = this.sub.subscribe_url + "?flag=" + t,
                            a = {};
                        a["surfboard"] = "surfboard:///install-config?url=" + encodeURIComponent(e), a["shadowrocket"] = "shadowrocket://add/sub://" + window.btoa(e).replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/, "") + "?remarks=" + window.APP_NAME, a["surge"] = "surge:///install-config?url=" + encodeURIComponent(e), a["surge3"] = "surge3:///install-config?url=" + encodeURIComponent(e), a["clash"] = "clash://install-config?url=" + encodeURIComponent(e), a["hiddify"] = "hiddify://install-config?url=" + encodeURIComponent(e) + "/LANDOG.BUZZ", window.location.href = a[t]
                    }, copySublink() {
                        ...
                        rt().then(t => {
                            this.noticeList = t.data, t.data.length > 0 && (this.noticeDetail = t.data[0]), this.loading = !1
                        }), lt().then(t => {
                            this.sub = t.data, this.loading = !1
                        }), ct().then(t => {
                            this.stat = t.data, this.stat[0] > 0 && F.$emit("haveNoPay", !0), this.loading = !1
                        })
                    }, resetSublink() {
                        xt().then(t => {
            ...
            Zt = Jt,
            Kt = (a("ac88"), Object(o["a"])(Zt, Ut, Qt, !1, null, null, null)),
            Gt = Kt.exports,
            Xt = function() {
                var t = this,
                    e = t._self._c;
                ...
                methods: {
                    onSubmit() {
                        B({
                            ...
                            t.data && (this.$message.success("登录成功"), this.$store.commit("setToken", t.data.auth_data), F.$emit("LoginSidebar"), setTimeout(() => {
                                this.$router.push({
                                    path: "/dashboard"
                                })
                            }, 1e3))
            ...
            ae = ee,
            se = Object(o["a"])(ae, Xt, te, !1, null, null, null),
            ie = se.exports,
            ne = function() {
                var t = this,
                    e = t._self._c;
                return e("div", {
                ...
                }, t._l(t.config.email_whitelist_suffix, (function(a, s) {
                    ...
                    staticClass: "count"
                }, [t._v(t._s(t.count) + " s")])])], 1) : t._e(), e("div", {
                    staticClass: "form-group input-group input-group-alternative"
                }, [t._m(5), e("input", {
                    directives: [{
                        name: "model",
                ...
                }, [t._v("服务条款")])])])], 1)]), 1 === t.config.is_recaptcha ? e("div", [e("reCaptcha", {
                    attrs: {
            ...
            de = ce,
            pe = Object(o["a"])(de, re, le, !1, null, null, null),
            ue = pe.exports,
            me = {
                name: "register",
                components: {
                ...
                methods: {
                    getConfig() {
                        P().then(t => {
                            this.config = t.data, t.data.email_whitelist_suffix && (this.email_suffix = t.data.email_whitelist_suffix[0]), t.data.is_invite_force ? this.invite_text = "邀请码(必填)" : this.invite_text = "邀请码(选填)"
                        })
                    }, sendMail(t) {
                        ...
                        let a = new RegExp("^[A-Za-z\\d]+([-_.][A-Za-z\\d]+)*@([A-Za-z\\d]+[-.])+[A-Za-z\\d]{2,4}$");
                        ...
                        this.recaptcha_data && (i.recaptcha_data = this.recaptcha_data), N(i).then(t => {
                            t.data && (this.$message.success("发送成功"), this.count = s, this.show = !1, this.timer = setInterval(() => {
                                this.count > 0 && this.count <= s ? this.count-- : (this.show = !0, clearInterval(this.timer), this.timer = null)
                            }, 1e3))
                        })
                    }, onSubmit() {
                        return this.form.email ? this.form.password ? this.form.auth_password !== this.form.password ? (this.$message.warning("两次密码输入不一致"), !1) : this.config.is_invite_force && !this.form.invite_code ? (this.$message.warning("请输入邀请码"), !1) : this.config.is_email_verify && !this.form.email_code ? (this.$message.warning("请输入邮箱验证码"), !1) : (this.email_suffix && (this.form.email = this.form.email + "@" + this.email_suffix), void I(this.form).then(t => {
            ...
            he = me,
            fe = (a("40f9"), Object(o["a"])(he, ne, oe, !1, null, null, null)),
            ge = fe.exports,
            ve = function() {
                var t = this,
                    e = t._self._c;
            ...
            _e = {
                ...
                methods: {
                    getConfig() {
                        P().then(t => {
                            this.config = t.data, t.data.is_invite_force ? this.invite_text = "邀请码(必填)" : this.invite_text = "邀请码(选填)"
                        })
                    }, sendMail(t) {
                        if (!this.form.email) return this.$message.warning("请先输入邮箱"), !1;
                        let e = new RegExp("^[a-z0-9]+([._\\-]*[a-z0-9])*@([a-z0-9]+[-a-z0-9]*[a-z0-9]+.){1,63}[a-z0-9]+$");
                        ...
                        this.recaptcha_data && (s.recaptcha_data = this.recaptcha_data), N(s).then(t => {
                            t.data && (this.$message.success("发送成功"), this.count = a, this.show = !1, this.timer = setInterval(() => {
                                this.count > 0 && this.count <= a ? this.count-- : (this.show = !0, clearInterval(this.timer), this.timer = null)
                            }, 1e3))
                        })
                    }, onSubmit() {
                        return this.form.email ? this.form.password ? this.form.auth_password !== this.form.password ? (this.$message.warning("两次密码输入不一致"), !1) : this.config.is_email_verify && !this.form.email_code ? (this.$message.warning("请输入邮箱验证码"), !1) : void z(this.form).then(t => {
            ...
            ye = _e,
            Ce = Object(o["a"])(ye, ve, be, !1, null, null, null),
            we = Ce.exports,
            xe = function() {
                var t = this,
                    e = t._self._c;
                return e("div", [e("a-spin", {
                    ...
                    return e("div", {
                        ...
                        return e("li", {
                            ...
                            on: {
                                click: function(e) {
                                    return t.showDrawer(a.id)
                                }
                            }
                        }, [t._v(t._s(a.title))])]), e("small", [t._v("更新时间: " + t._s(t._f("formatDate")(a.updated_at)))])]), e("div", {
                            staticClass: "col-auto"
                        }, [e("button", {
                ...
                methods: {
                    showDrawer(t) {
                        ...
                        try {
                            ...
                            t.selectNode(a), window.getSelection().removeAllRanges(), window.getSelection().addRange(t), document.execCommand("copy"), window.getSelection().removeAllRanges(), this.$message.success("复制成功")
                        } catch (s) {
            ...
            De = $e,
            Te = Object(o["a"])(De, xe, ke, !1, null, "ead19264", null),
            Oe = Te.exports,
            Ae = function() {
                var t = this,
                    e = t._self._c;
                return e("div", [e("base-header", {
                    ...
                    staticClass: "card-body text-center"
                }, [0 === t.serveList.length ? e("div", [e("a-empty", [e("span", {
                    attrs: {
                        slot: "description"
                    },
                    slot: "description"
                }, [t._v(" 暂无数据 ")])])], 1) : t._e(), t.serveList ? e("div", {
                    staticClass: "row"
                }, t._l(t.serveList, (function(a, s) {
                    return e("div", {
                        key: s,
                        ...
                        class: a.last_check_at ? "label-success" : "label-danger"
                    }), t._v(" " + t._s(a.name) + " ")]), 
                    e("div", {
                ...
                methods: {
                    getData() {
                        lt().then(t => {
                            ...
                            let e = [],
                                a = ["香港", "美国", "日本", "中国", "俄罗斯", "韩国", "英国", "新加坡", "马来西亚", "台湾", "加拿大", "菲律宾", "德国", "印度", "南非", "卢森堡", "巴西", "意大利", "法国", "泰国", "爱尔兰"];
                            t.data.forEach((function(t) {
                                ...
                                "json" == typeof t.tags && obj && (t.tags = JSON.parse(t.tags)), e.push(t)
                            })), this.serveList = e
                        })
                    }, copySublink() {
                        const t = this.$createElement;
            ...
            Ne = Be,
            Ie = (a("74a8"), Object(o["a"])(Ne, Ae, Pe, !1, null, "889ddab4", null)),
            ze = Ie.exports,
            Me = function() {
                var t = this,
                    e = t._self._c;
                return e("div", [e("a-spin", {
                    ...
                    slot: "description"
                }, [t._v(" 暂无套餐商品 ")])]) : t._l(t.list, (function(a, s) {
                    return e("div", {
                        key: s,
                    ...
                    }, [t._v(t._s(t._f("money")(a.month_price)))]) : a.quarter_price ? e("div", {
                        staticClass: "display-2"
                    }, [t._v(t._s(t._f("money")(a.quarter_price)))]) : a.half_year_price ? e("div", {
                        staticClass: "display-2"
                    }, [t._v(t._s(t._f("money")(a.half_year_price)))]) : a.year_price ? e("div", {
                        staticClass: "display-2"
                    }, [t._v(t._s(t._f("money")(a.year_price)))]) : a.two_year_price ? e("div", {
                        staticClass: "display-2"
                    }, [t._v(t._s(t._f("money")(a.two_year_price)))]) : a.three_year_price ? e("div", {
                        staticClass: "display-2"
                    }, [t._v(t._s(t._f("money")(a.three_year_price)))]) : a.onetime_price ? e("div", {
                        staticClass: "display-2"
                    }, [t._v(t._s(t._f("money")(a.onetime_price)))]) : t._e(), a.month_price ? e("span", {
                        staticClass: "text-muted"
                    }, [t._v("月付")]) : a.quarter_price ? e("span", {
                        staticClass: "text-muted"
                    }, [t._v("季付")]) : a.half_year_price ? e("span", {
                        staticClass: "text-muted"
                    }, [t._v("半年付")]) : a.year_price ? e("span", {
                        staticClass: "text-muted"
                    }, [t._v("年付")]) : a.two_year_price ? e("span", {
                        staticClass: "text-muted"
                    }, [t._v("两年付")]) : a.three_year_price ? e("span", {
                        staticClass: "text-muted"
                    }, [t._v("三年付")]) : a.onetime_price ? e("span", {
                        staticClass: "text-muted"
                    }, [t._v("一次性")]) : t._e(), e("p", {
                        staticStyle: {
                            width: "250px"
            ...
            We = Le,
            Ee = Object(o["a"])(We, Me, Re, !1, null, "1229a100", null),
            qe = Ee.exports,
            Fe = function() {
                var t = this,
                    e = t._self._c;
                ...
                }, [t.data.month_price ? e("a-radio-button", {
                    staticClass: "shop-button",
                    attrs: {
                        value: "month_price"
                    }
                }, [e("h3", [t._v("月付")]), e("span", [t._v(t._s(t._f("money")(t.data.month_price)))])]) : t._e(), t.data.quarter_price ? e("a-radio-button", {
                    staticClass: "shop-button",
                    attrs: {
                        value: "quarter_price"
                    }
                }, [e("h3", [t._v("季付")]), e("span", [t._v(t._s(t._f("money")(t.data.quarter_price)))])]) : t._e(), t.data.half_year_price ? e("a-radio-button", {
                    staticClass: "shop-button",
                    attrs: {
                        value: "half_year_price"
                    }
                }, [e("h3", [t._v("半年付")]), e("span", [t._v(t._s(t._f("money")(t.data.half_year_price)))])]) : t._e(), t.data.year_price ? e("a-radio-button", {
                    staticClass: "shop-button",
                    attrs: {
                        value: "year_price"
                    }
                }, [e("h3", [t._v("年付")]), e("span", [t._v(t._s(t._f("money")(t.data.year_price)))])]) : t._e(), t.data.two_year_price ? e("a-radio-button", {
                    staticClass: "shop-button",
                    attrs: {
                        value: "two_year_price"
                    }
                }, [e("h3", [t._v("两年付")]), e("span", [t._v(t._s(t._f("money")(t.data.two_year_price)))])]) : t._e(), t.data.three_year_price ? e("a-radio-button", {
                    staticClass: "shop-button",
                    attrs: {
                        value: "three_year_price"
                    }
                }, [e("h3", [t._v("三年付")]), e("span", [t._v(t._s(t._f("money")(t.data.three_year_price)))])]) : t._e(), t.data.onetime_price ? e("a-radio-button", {
                    staticClass: "shop-button",
                    attrs: {
                        value: "onetime_price"
                    }
                }, [e("h3", [t._v("一次性")]), e("span", [t._v(t._s(t._f("money")(t.data.onetime_price)))])]) : t._e(), t.data.reset_price ? e("a-radio-button", {
                    staticClass: "shop-button",
                    attrs: {
                        value: "reset_price"
                    }
                }, [e("h3", [t._v("重置流量包")]), e("span", [t._v(t._s(t._f("money")(t.data.reset_price)))])]) : t._e()], 1)], 1), e("div", {
                    staticClass: "col-lg-6"
                }, [e("a-input-search", {
                    attrs: {
                        placeholder: "输入优惠卷",
                ...
                }, [t._v(t._s(t.data.name) + " x " + t._s(t.period_text))]), e("span", {
                    staticStyle: {
                        "font-size": "large",
                        float: "right"
                    }
                }, [t._v(t._s(t._f("money")(t.total)))])]), t.discount_price ? e("div", [e("hr", {
                    staticClass: "my-3"
                }), e("span", {
                    staticStyle: {
                        "font-size": "large"
                    }
                }, [t._v("抵扣金额：" + t._s(t._f("money")(t.discount_price)))]), e("hr", {
                    staticClass: "my-3"
                })]) : t._e(), e("div", {
                    staticStyle: {
                        "margin-top": "1rem"
                    }
                }, [e("h2", [t._v("总计：" + t._s(t._f("money")(t.total)))])])], 1)])]), e("div", {
                    staticClass: "card-footer"
                }, [e("button", {
                ...
                methods: {
                    getData(t) {
                        ...
                        gt({
                            ...
                            if (this.coupon_code = t.data.code, 1 === t.data.type) this.total = (this.price - t.data.value).toFixed(2), this.discount_price = -t.data.value;
                            else {
                                let e = parseFloat((100 - t.data.value) / 100);
                                this.total = (this.price * e).toFixed(2), this.discount_price = (this.total - this.price).toFixed(2)
                            }
                        })
                    }, onSubmit() {
                        let t = {
                        ...
                        this.coupon_code && (t["coupon_code"] = this.coupon_code), vt(t).then(t => {
                            t.data && this.$router.push({
                                name: "订单详情",
                                params: {
                                    id: t.data
                        ...
                        this.period_text = this.periodList[this.period], this.total = this.data[this.period], this.price = this.data[this.period]
                    }
                },
                filters: {
                    formatDate: function(t) {
            ...
            He = Ye,
            Ue = (a("c38a"), Object(o["a"])(He, Fe, Ve, !1, null, "0c1eb0b3", null)),
            Qe = Ue.exports,
            Je = function() {
                var t = this,
                    e = t._self._c;
                return e("div", [e("a-spin", {
                    ...
                    staticClass: "card-body"
                }, [e("h3", [t._v(t._s(t.data.plan.name))]), e("p", [t._v("流量：" + t._s(t.data.plan.transfer_enable) + " GB")]), e("p", {
                    domProps: {
                    ...
                    staticClass: "text-uppercase text-muted ls-1 mb-1"
                }, [t._v(" # " + t._s(t.data.trade_no))])]), e("div", {
                ...
                }, [t._v(t._s(t.data.plan.name) + " x " + t._s(t.periodList[t.data.period]))]), e("span", {
                    staticStyle: {
                        "font-size": "large",
                        float: "right"
                    }
                }, [t._v(t._s(t._f("money")(t.data.plan[t.data.period])))])]), t.data.discount_amount ? e("div", [e("hr", {
                    staticClass: "my-3"
                }), e("span", {
                    staticStyle: {
                        "font-size": "large"
                ...
                }, [t._v(t._s(t._f("money")(t.data.discount_amount)))])]) : t._e(), t.data.balance_amount ? e("div", [e("hr", {
                    staticClass: "my-3"
                }), e("span", {
                    staticStyle: {
                        "font-size": "large"
                ...
                }, [t._v(t._s(t._f("money")(t.data.balance_amount)))])]) : t._e(), e("div", {
                    staticStyle: {
                        "margin-top": "1rem"
                    }
                }, [e("hr", {
                ...
                }, [t._v("总计：" + t._s(t._f("money")(t.data.total_amount)))])])]), e("div", {
                    staticClass: "col-xl-6"
                }, [t.payment_method ? e("p", [t._v("支付方式：")]) : t._e(), e("a-radio-group", {
                    model: {
                        value: t.payment,
                        callback: function(e) {
                            t.payment = e
                ...
                }, t._l(t.payment_method, (function(a, s) {
                    return e("a-radio-button", {
                        key: s,
                        staticClass: "shop-button",
                        attrs: {
                            value: a.id
                        }
                    }, [e("h3", [t._v(t._s(a.name))])])
                })), 1)], 1)])]), e("div", {
                    staticClass: "card-footer"
                }, [e("button", {
                    staticClass: "btn btn-icon btn-primary",
                ...
                }, [t._v("开通中")]), e("p", [t._v("订单系统正在进行处理，请稍等1-3分钟。")])])])]) : t._e(), 2 === t.showResult ? e("div", {
                    staticClass: "row justify-content-center"
                }, [e("div", {
                    staticClass: "card mb-4 col-sm-12 col-xl-8 mb-3"
                }, [e("div", {
            ...
            Xe = {
                ...
                mounted() {
                    ...
                    F.$on("close", (function() {
                        t.showQrCode = !1
                    })), t.order_id = this.$route.params.id, t.getData(this.order_id), window.clearInterval()
                },
                methods: {
                    getData(t) {
                        let e = this;
                        mt({
                            ...
                            if (e.loading = !1, e.data = t.data, e.showResult = t.data.status, 0 === t.data.status) {
                                var a = this.order_id;
                        ...
                        bt({
                            ...
                            t.data && 1 === t.type ? (window.clearInterval(), window.location.href = t.data) : t.data && 0 === t.type ? (this.showQrCode = !0, document.getElementById("qrCode").innerHTML = "", new Ge.a(this.$refs.qrCodeDiv, {
                                text: t.data,
                                width: 250,
                                height: 250,
                                colorDark: "#333333",
                                colorLight: "#ffffff",
                                correctLevel: Ge.a.CorrectLevel.L
                            })) : t.data && -1 === t.type && (this.showResult = !0, window.clearInterval())
                        })
                    }, cancelOrder(t) {
                        zt({
                            trade_no: t
            ...
            ta = Xe,
            ea = (a("afde"), Object(o["a"])(ta, Je, Ze, !1, null, null, null)),
            aa = ea.exports,
            sa = function() {
                var t = this,
                    e = t._self._c;
                return e("div", [e("a-spin", {
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function(a) {
                            return e("span", {}, [e("span", {
                                staticClass: "text-primary"
                            }, [t._v(t._s(t.periodList[a]))])])
                        }
                    }, {
                        key: "total_amount",
                        fn: function(a) {
                            return e("span", {}, [t._v(" " + t._s(t._f("money")(a)) + " ")])
                        }
                    }, {
                        key: "status",
                        fn: function(a) {
                            return e("span", {
                                ...
                                class: t.statusLabel[a]
                            }), t._v(" " + t._s(t.statusText[a]) + " ")])
                        }
                    }, {
                        key: "created_at",
                        fn: function(a) {
                            return e("span", {}, [t._v(" " + t._s(t._f("formatDate")(a)) + " ")])
                        }
                    }, {
                        key: "action",
                        fn: function(a, s) {
                            ...
                            }, [t._v("查看详情")]) : t._e(), e("br"), 0 === s.status ? e("a", {
            ...
            oa = na,
            ra = (a("f160"), Object(o["a"])(oa, sa, ia, !1, null, null, null)),
            la = ra.exports,
            ca = function() {
                var t = this,
                    e = t._self._c;
                return e("div", [e("a-spin", {
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function() {
                            return [e("span", {
                                staticClass: "text-nowrap"
                            }, [t._v(" 确认中的佣金 "), e("a-tooltip", {
                                attrs: {
                                    placement: "bottom"
                                }
                            }, [e("template", {
                                slot: "title"
                            }, [t._v(" 佣金将会在确认后会到达你的佣金账户。 ")]), e("a-icon", {
                                attrs: {
                        ...
                        fn: function(a, s) {
                            return e("span", {}, [e("div", {
                                ...
                                directives: [{
                                    name: "clipboard",
                                    rawName: "v-clipboard:copy",
                                    // value: t.hostport + "/#/register?code=" + s.code,
                                    // expression: "hostport + '/#/register?code=' + record.code",
                                    value: t.hostport + "/?path=register&code=" + s.code,
                                    expression: "hostport + '/?path=register&code=' + record.code",
                                    arg: "copy"
                                }, {
                                    name: "clipboard",
                                    rawName: "v-clipboard:success",
    ...
    // 获取 hostport 数据并在获取成功后调用 getData
    this.fetchHostport().then(() => {
      this.getData();
    });
  },
                methods: {
                    async fetchHostport() {
      try {
        const response = await fetch('/hostport.php');
        const data = await response.json();
        this.hostport = data.hostport;
      } catch (error) {
        console.error('Error fetching hostport:', error);
        this.hostport = ''; // 处理获取失败的情况
      }
    },
    getData() {
      yt().then(t => {
        this.loading = false;
        this.stat = t.data.stat;
        this.code = t.data.codes;
      }).catch(error => {
      ...
      wt().then(t => {
        ...
        console.error('Error fetching wt data:', error);
      });
    },
    copyInviteUrl() {
      const t = this.$createElement;
      this.$notification.open({
        ...
        icon: t("a-icon", {
          ...
          style: "color: #108ee9"
            ...
            ua = pa,
            ma = Object(o["a"])(ua, ca, da, !1, null, "7a5aede6", null),
            ha = ma.exports,
            fa = function() {
                var t = this,
                    e = t._self._c;
                return e("div", [e("a-spin", {
                    ...
                    staticClass: "col-xl-6"
                }, [t.config.withdraw_close ? t._e() : e("base-button", {
                    attrs: {
                        type: "info",
                        outline: "",
                        icon: "ni ni-money-coins"
                    ...
                    staticClass: "mt-3"
                }, [e("strong", [t._v("到期邮件提醒:")]), e("a-switch", {
                    ...
                    staticClass: "mt-3"
                }, [e("strong", [t._v("流量邮件提醒:")]), e("a-switch", {
                    staticClass: "float-right",
                    attrs: {
                        "default-checked": ""
                    },
                ...
                })], 1), t.config.is_telegram ? e("div", {
                    staticClass: "mt-3"
                }, [e("hr"), e("strong", [t._v("绑定Telegram")]), e("base-button", {
                    staticClass: "float-right",
                    attrs: {
                        type: "primary",
                        size: "sm"
                ...
                }, t._l(t.withdraw_methods, (function(a, s) {
                    return e("option", {
                        key: s,
                        domProps: {
                            value: a
                    ...
                    staticClass: "p-3"
                }, [e("a-timeline", [e("a-timeline-item", [e("h3", [t._v("第一步")]), e("p", [t._v("打开Telegram搜索@" + t._s(t.tg_name))])]), e("a-timeline-item", [e("h3", [t._v("第二步")]), e("p", [t._v("向机器人发送 /bind " + t._s(t.sub.subscribe_url) + " 命令")])])], 1)], 1)])], 1)
            },
            ga = [],
            va = {
                name: "profile",
                ...
                methods: {
                    getData() {
                        ot().then(t => {
                            ...
                            this.config = t.data, t.data.withdraw_methods && (this.withdraw_methods = t.data.withdraw_methods, this.withdraw_method = t.data.withdraw_methods[0])
                        }), lt().then(t => {
                            this.sub = t.data
                        })
                    }, onSubmit1() {
                        ...
                        return this.withdraw_method ? this.withdraw_account ? void jt({
            ...
            ba = va,
            _a = Object(o["a"])(ba, fa, ga, !1, null, "50204db1", null),
            ya = _a.exports,
            Ca = function() {
                var t = this,
                    e = t._self._c;
                return e("div", [e("a-spin", {
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function(a, s) {
                            ...
                            }, [t._v("查看")]), 0 === s.status ? e("a-divider", {
                                attrs: {
                                    type: "vertical"
                                }
                            }) : t._e(), 0 === s.status ? e("a", {
            ...
            xa = {
                ...
                methods: {
                    getData() {
                        ...
                        return this.form.subject ? this.form.message ? void At(this.form).then(t => {
                        ...
                        this.reply_id = t, this.modal2 = !0, Nt({
                            id: t
                        }).then(t => {
            ...
            ka = xa,
            Sa = (a("fc36"), Object(o["a"])(ka, Ca, wa, !1, null, null, null)),
            ja = Sa.exports,
            $a = function() {
                var t = this,
                    e = t._self._c;
                return e("div", [e("a-spin", {
                ...
                }, [e("strong", [t._v("流量明细仅保留近一个月数据以供查询。")])]), e("a-table", {
                    attrs: {
                        columns: t.columns,
                        "data-source": t.list,
                        pagination: !1,
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function(a, s) {
                            return e("span", {}, [
                                e("span", { staticClass: "text-primary" }, [
                                    t._v(
                                        t._s(
                                            t._f("bytesToSize")((+a || 0) * (+s.server_rate || 1))
                                        )
                                    )
                                ])
                            ])
                        ...
                        key: "server_rate",
                        fn: function(a) {
                            return e("span", {}, [e("a-tag", [t._v(t._s(a + " x"))])], 1)
                        }
                    }, {
                        key: "record_at",
                        fn: function(a) {
            ...
            Ta = {
                ...
                methods: {
                    getData() {
                        this.loading2 = !0, It(this.param).then(t => {
                            this.loading2 = !1, this.loading = !1, this.list = t.data, this.param.total = t.total
                        })
                    }, currentPage(t, e) {
            ...
            Oa = Ta,
            Aa = Object(o["a"])(Oa, $a, Da, !1, null, "69b51d7c", null),
            Pa = Aa.exports;
        s["a"].use(d["a"]);
        const Ba = [{
                path: "/",
            ...
            Ia = "undefined" != localStorage.getItem("config") ? JSON.parse(localStorage.getItem("config")) : [];
        Na.beforeEach((t, e, a) => {
            document.title = Ia ? `${t.name} | ${window.APP_NAME}` : "" + t.name, a({
                query: t.query
            })
        }), Na.afterEach((t, e, a) => {
        ...
        var za = Na,
            ...
            Ea = Wa,
            qa = Object(o["a"])(Ea, Ra, La, !1, null, null, null),
            Fa = qa.exports,
            Va = function() {
                var t = this,
                    e = t._self._c;
            ...
            Ua = Ha,
            Qa = Object(o["a"])(Ua, Va, Ya, !1, null, null, null),
            Ja = Qa.exports,
            Za = function() {
                var t = this,
                    e = t._self._c;
            ...
            Xa = Ga,
            ts = Object(o["a"])(Xa, Za, Ka, !1, null, null, null),
            es = ts.exports,
            as = function() {
                var t = this,
                    e = t._self._c;
                    ...
                    on: {
                        change: function(e) {
                            ...
                            if (Array.isArray(a)) {
                                var n = null,
                                    o = t._i(a, n);
                                s.checked ? o < 0 && (t.model = a.concat([n])) : o > -1 && (t.model = a.slice(0, o).concat(a.slice(o + 1)))
                            } else t.model = i
                        }
                    }
                }), e("label", {
        ...
        var ns = {
            ...
            os = ns,
            rs = Object(o["a"])(os, as, ss, !1, null, null, null),
            ls = rs.exports,
            cs = function() {
                var t = this,
                    e = t._self._c;
            ...
            us = ps,
            ms = (a("4da3"), Object(o["a"])(us, cs, ds, !1, null, null, null)),
            hs = ms.exports,
            fs = function() {
                var t = this,
                    e = t._self._c;
            ...
            bs = vs,
            _s = (a("aa2b"), Object(o["a"])(bs, fs, gs, !1, null, "41a76e0c", null)),
            ys = _s.exports,
            Cs = function() {
                var t = this,
                    e = t._self._c;
            ...
            ks = xs,
            Ss = Object(o["a"])(ks, Cs, ws, !1, null, null, null),
            js = Ss.exports,
            $s = function() {
                var t = this,
                    e = t._self._c;
                return e("div", {
                    ...
                    }, [t._v(" " + t._s(t.label) + " "), t.required ? e("span", [t._v("*")]) : t._e()]) : t._e()]
            ...
            Ts = {
                ...
                computed: {
                    listeners() {
                        return {...this, input: this.updateValue, focus: this.onFocus, blur: this.onBlur
                        }
                    }, hasIcon() {
                        const {
                            addonRight: t,
                        ...
                        return void 0 !== t || void 0 !== e || void 0 !== this.addonRightIcon || void 0 !== this.addonLeftIcon
                    }
                },
                methods: {
                    updateValue(t) {
            ...
            Os = Ts,
            As = Object(o["a"])(Os, $s, Ds, !1, null, null, null),
            Ps = As.exports,
            Bs = function() {
                var t = this,
                    e = t._self._c;
            ...
            Rs = Ms,
            Ls = Object(o["a"])(Rs, Is, zs, !1, null, null, null),
            Ws = Ls.exports,
            Es = {
                name: "base-nav",
                components: {
                    NavbarToggleButton: Ws
                },
                props: {
                    type: {
                        type: String,
            ...
            qs = Es,
            Fs = Object(o["a"])(qs, Bs, Ns, !1, null, null, null),
            Vs = Fs.exports,
            Ys = function() {
                var t = this,
                    e = t._self._c;
            ...
            Qs = Us,
            Js = Object(o["a"])(Qs, Ys, Hs, !1, null, null, null),
            Zs = Js.exports,
            Ks = function() {
                var t = this,
                    e = t._self._c;
            ...
            ti = Xs,
            ei = Object(o["a"])(ti, Ks, Gs, !1, null, null, null),
            ai = ei.exports,
            si = function() {
                var t = this,
                    e = t._self._c;
            ...
            oi = ni,
            ri = Object(o["a"])(oi, si, ii, !1, null, null, null),
            li = ri.exports,
            ci = function() {
                var t = this,
                    e = t._self._c;
            ...
            ui = pi,
            mi = Object(o["a"])(ui, ci, di, !1, null, null, null),
            hi = mi.exports,
            fi = function() {
                var t = this,
                    e = t._self._c;
                return e("table", {
                    ...
                    return e("tr", {
                        ...
                        return t._l(t.columns, (function(s) {
                            return e("td", {
                                key: s
                            }, [t.hasValue(a, s) ? [t._v(" " + t._s(t.itemValue(a, s)) + " ")] : t._e()], 2)
                        }))
                    }), {
                        item: a
                    })], 2)
            ...
            bi = vi,
            _i = Object(o["a"])(bi, fi, gi, !1, null, null, null),
            yi = _i.exports,
            Ci = function() {
                var t = this,
                    e = t._self._c;
                return e("div", {
                    ...
                    staticClass: "card-body",
                    class: t.bodyClasses
                }, [t._t("default")], 2), t.noBody ? t._t("default") : t._e(), t.$slots.footer ? e("div", {
                    staticClass: "card-footer",
            ...
            ki = xi,
            Si = Object(o["a"])(ki, Ci, wi, !1, null, null, null),
            ji = Si.exports,
            $i = function() {
                var t = this,
                    e = t._self._c;
            ...
            Ti = {
                ...
                methods: {
                    closeModal() {
                        this.$emit("update:show", !1), F.$emit("close")
                    }
                },
                watch: {
                    show(t) {
            ...
            Oi = Ti,
            Ai = (a("7fda"), Object(o["a"])(Oi, $i, Di, !1, null, null, null)),
            Pi = Ai.exports,
            Bi = function() {
                var t = this,
                    e = t._self._c;
                return e("card", {
                    ...
                    }, [t._v(" " + t._s(t.title) + " ")]) : t._e(), t.subTitle ? e("span", {
            ...
            zi = Ii,
            Mi = Object(o["a"])(zi, Bi, Ni, !1, null, null, null),
            Ri = Mi.exports,
            Li = function() {
                var t = this,
                    e = t._self._c;
            ...
            qi = Ei,
            Fi = Object(o["a"])(qi, Li, Wi, !1, null, null, null),
            Vi = Fi.exports,
            Yi = function() {
                var t = this,
                    e = t._self._c;
                        ...
                        fn: function() {
                            return [e("div", {
                                ...
                                return e("li", {
                                    ...
                                    on: {
                                        click: function(e) {
                                            return e.preventDefault(), t.activateTab(a)
                                        }
                                    }
                                }, [a.icon ? e("i", {
                                    class: a.icon
                                }) : t._e(), e("tab-item-content", {
                                    attrs: {
                                        tab: a
                                    }
                                })], 1)])
            ...
            Qi = [],
            Ji = {},
            Zi = Object(o["a"])(Ji, Ui, Qi, !1, null, null, null),
            Ki = Zi.exports,
            Gi = function() {
                var t = this,
                    e = t._self._c;
            ...
            en = tn,
            an = Object(o["a"])(en, Gi, Xi, !1, null, null, null),
            sn = an.exports,
            nn = {
                name: "tabs",
                components: {
                ...
                methods: {
                    findAndActivateTab(t) {
                        ...
                        this.handleClick && this.handleClick(t), this.deactivateTabs(), t.active = !0, this.activeTabIndex = this.tabs.findIndex(t => t.active)
                    }, deactivateTabs() {
                        this.tabs.forEach(t => {
                            t.active = !1
                        })
                ...
                mounted() {
                    this.$nextTick(() => {
                        this.value ? this.findAndActivateTab(this.value) : this.tabs.length > 0 && this.activateTab(this.tabs[0])
                    })
                },
                watch: {
                    value(t) {
            ...
            on = nn,
            rn = Object(o["a"])(on, Yi, Hi, !1, null, null, null),
            ln = rn.exports;
        const cn = {
            install(t) {
                t.component("badge", Fa), t.component("base-alert", Ja), t.component("base-button", es), t.component("base-checkbox", ls), t.component("base-dropdown", hs), t.component("base-dropdown2", ys), t.component("base-header", js), t.component("base-input", Ps), t.component("base-nav", Vs), t.component("base-pagination", Zs), t.component("base-progress", ai), t.component("base-switch", li), t.component("base-radio", hi), t.component("base-table", yi), t.component("card", ji), t.component("modal", Pi), t.component("stats-card", Ri), t.component("tab-pane", Vi), t.component("tabs", ln)
            }
        };
        var dn = cn,
            pn = {
        ...
        const un = {
            install(t) {
                t.directive("click-outside", pn)
            }
        };
        var mn = un,
            hn = (a("4d1c"), a("797e"), a("a4d4"), {
                install(t) {
                    t.use(dn), t.use(mn)
                }
            }),
        ...
        s["a"].directive("highlight", (function(t) {
            ...
            e.forEach(t => {
                bn.a.highlightBlock(t)
            })
        })), s["a"].use(gn.a), s["a"].config.productionTip = !1, s["a"].use(Ma["a"]), s["a"].use(hn), new s["a"]({
            router: za,
            store: O,
            render: t => t(c)
        }).$mount("#app")
    ...
    d06d: function(t, e, a) {},
    d0a5: function(t, e, a) {
        t.exports = a.p + "theme/typora-theme/img/pay-success.5f5f21d8.svg"
    },
    d0b6: function(t, e, a) {
        "use strict";
        a("00fb")
